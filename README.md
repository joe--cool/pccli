...
The first supported journey is read-only discovery in the Services music library: finding songs and reviewing their arrangements.
...
Released binaries will be published for macOS, Linux, and Windows through GitHub Releases using GoReleaser.
...
```sh
PCCLI_MOCK=true go run ./cmd/pccli songs list
```
